...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.treeview_os_directories.sizePolicy().hasHeightForWidth())
        self.treeview_os_directories.setSizePolicy(sizePolicy2)
        self.treeview_os_directories.setMinimumSize(QSize(200, 200))
        ...
        self.treeview_os_directories.setProperty("showDropIndicator", True)
        self.treeview_os_directories.setDragEnabled(False)
        self.treeview_os_directories.setSortingEnabled(True)
        self.treeview_os_directories.header().setProperty("showSortIndicator", True)
